...
export type ProviderName = "openai" | "anthropic" | "gemini" | "deepseek" | "qwen" | "xml" | "markdown" | "custom"
...
export interface NormalizedDelta {
	type: "toolDetected" | "toolId" | "toolName" | "argumentsDelta" | "toolStop" | "text"
	index?: number
	id?: string
	name?: string
	arguments?: string
...
export type ToolStreamListener<E extends EventKind> = (...args: ToolStreamEventMap[E]) => void | Promise<void> | unknown
