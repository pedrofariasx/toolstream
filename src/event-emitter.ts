...
export class ToolStreamEmitter {
	...
	protected emitSync<E extends EventKind>(event: E, ...args: ToolStreamEventMap[E]): void {
	...
	protected async emitAsync<E extends EventKind>(event: E, ...args: ToolStreamEventMap[E]): Promise<void> {
