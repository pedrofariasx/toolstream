...
import { JsonRepairer, JsonStreamParser } from "./json-stream.js"
...
import { StateMachineState, TokenType, ToolStreamError } from "./types.js"
...
export class ToolStream extends ToolStreamEmitter {
	...
	push(chunk: string): this {
		if (this.finalized) {
			throw new ToolStreamError("Parser is finalized. Create a new instance or call reset().", "FINALIZED")
		}
